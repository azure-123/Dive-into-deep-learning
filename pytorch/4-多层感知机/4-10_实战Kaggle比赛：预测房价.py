...
def k_fold(k, X_train, y_train, num_epochs, learning_rate, weight_decay, batch_size):
    ...
    for i in range(k):
        ...
        net = get_net()
        train_ls, valid_ls = train(net, *data, num_epochs=num_epochs, learning_rate=learning_rate, weight_decay=weight_decay,batch_size=batch_size)
...
train_l, test_l = k_fold(k, train_features, train_labels, num_epochs, learning_rate, weight_decay, batch_size)