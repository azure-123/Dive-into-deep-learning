...
def load_cifar10(is_train, augs, batch_size):
    dataset = torchvision.datasets.CIFAR10(train=True, root='../data', download=True, transform=augs)
    dataloader = data.DataLoader(dataset=dataset, batch_size=batch_size, is_train=is_train)
    return dataloader
...
def train_with_data_aug(train_augs, test_augs, net, lr=0.001):
    ...
    trainer = torch.optim(net.parameters(), lr)
